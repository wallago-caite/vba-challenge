...
For Z = 2 To lastRow
    ...
    'change the colors in yearly and percentchange
        If Cells(Z, 10).Value >= 0 Then
            Cells(Z, 10).Interior.Color = vbGreen
            Cells(Z, 11).Interior.Color = vbGreen
...
Dim greatestpercentincrease As Double
    greatestpercentincrease = Application.WorksheetFunction.max(Range("K2:K100"))
        Range("Q2").Value = greatestpercentincrease

Dim tickerpercentin As String
    tickerpercentin = Application.WorksheetFunction.XLookup(Range("q2"), Range("K2:K100"), Range("I2:I100"), 0, 0, 1)
        Range("P2").Value = tickerpercentin

'greatest decrease value and ticker then print
Dim greatestpercentdecrease As Double
    greatestpercentdecrease = Application.WorksheetFunction.min(Range("K2:K100"))
        Range("Q3").Value = greatestpercentdecrease

Dim tickerpercentdec As String
    tickerpercentdec = Application.WorksheetFunction.XLookup(Range("Q3"), Range("K2:K100"), Range("I2:I100"), 0, 0, 1)
        Range("P3").Value = tickerpercentdec

'greatest total value and ticker then print
Dim greatesttotal As LongLong
    greatesttotal = Application.WorksheetFunction.max(Range("L2:L100"))
        Range("Q4").Value = greatesttotal

Dim tickergreattotal As String
    tickergreattotal = Application.WorksheetFunction.XLookup(Range("Q4"), Range("L2:L100"), Range("I2:I100"), 0, 0, 1)
        Range("P4").Value = tickergreattotal
